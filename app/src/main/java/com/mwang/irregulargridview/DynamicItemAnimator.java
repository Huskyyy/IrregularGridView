...
/**
 * This is mainly based on the DefaultItemAnimator.
 * I just add the scale animation for my IrregularRecyclerView.
 */
public class DynamicItemAnimator extends SimpleItemAnimator {
    ...
    private static class MoveInfo {
        ...
        public int fromX, fromY, toX, toY, fromWidth, fromHeight, toWidth, toHeight;

        private MoveInfo(RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY, int fromWidth, int fromHeight, int toWidth, int toHeight) {
            this.holder = holder;
            this.fromX = fromX;
            this.fromY = fromY;
            this.toX = toX;
    ...
    private static class ChangeInfo {
        ...
        private ChangeInfo(RecyclerView.ViewHolder oldHolder, RecyclerView.ViewHolder newHolder,
                           int fromX, int fromY, int toX, int toY, int fromWidth, int fromHeight, int toWidth, int toHeight) {
    ...
    public boolean animateDisappearance(RecyclerView.ViewHolder viewHolder, ItemHolderInfo preLayoutInfo, ItemHolderInfo postLayoutInfo) {
        ...
        int oldRight = preLayoutInfo.right;
        int oldTop = preLayoutInfo.top;
        int oldBottom = preLayoutInfo.bottom;
        View disappearingItemView = viewHolder.itemView;
        RecyclerView.LayoutParams lp = (RecyclerView.LayoutParams) disappearingItemView.getLayoutParams();
        int newLeft = postLayoutInfo == null ? disappearingItemView.getLeft() : postLayoutInfo.left;
        int newRight = postLayoutInfo == null ? disappearingItemView.getRight() : postLayoutInfo.right;
        int newTop = postLayoutInfo == null ? disappearingItemView.getTop() : postLayoutInfo.top;
        int newBottom = postLayoutInfo == null ? disappearingItemView.getBottom() : postLayoutInfo.bottom;
    ...
    public boolean animateAppearance(@NonNull RecyclerView.ViewHolder viewHolder,
        ...
        if (preLayoutInfo != null){
            int fromWidth = preLayoutInfo.right - preLayoutInfo.left;
            int fromHeight = preLayoutInfo.bottom - preLayoutInfo.top;
            int toWidth = postLayoutInfo.right - postLayoutInfo.left;
            int toHeight = postLayoutInfo.bottom - postLayoutInfo.top;
    ...
    public boolean animatePersistence(@NonNull RecyclerView.ViewHolder viewHolder,
        ...
        int fromWidth = preInfo.right - preInfo.left;
...
//        }
    ...
    private void animateMoveImpl(final RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY, int fromWidth, int fromHeight, int toWidth, int toHeight) {
        final View view = holder.itemView;
    ...
    public boolean animateChange(RecyclerView.ViewHolder oldHolder, RecyclerView.ViewHolder newHolder,
        ...
        final float prevScaleX = ViewCompat.getScaleX(oldHolder.itemView);
        final float prevScaleY = ViewCompat.getScaleY(oldHolder.itemView);
        ...
        if (newHolder != null) {
            ...
            newHolder.itemView.setPivotX(0);
            newHolder.itemView.setPivotY(0);
            ViewCompat.setScaleX(newHolder.itemView, 1 / scaleX);
            ViewCompat.setScaleY(newHolder.itemView, 1 / scaleY);
            ViewCompat.setAlpha(newHolder.itemView, 0);
        }
        mPendingChanges.add(new ChangeInfo(oldHolder, newHolder, fromX, fromY, toX, toY, fromWidth, fromHeight, toWidth, toHeight));
        return true;
    }
    ...
    private void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0).translationY(0).
                    scaleX(1).scaleY(1).setDuration(getChangeDuration()).
    ...
    private boolean endChangeAnimationIfNecessary(ChangeInfo changeInfo, RecyclerView.ViewHolder item) {
        ...
        ViewCompat.setScaleX(item.itemView, 1);
        ViewCompat.setScaleY(item.itemView, 1);
